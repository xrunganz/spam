...
\____/| .__/ \__,_|_| |_| |_| \____/|_| |_| |_|___/
      | |                                          
      |_|  '''+W+'Creator : Xploit-Nahrun Ganz\n\t\tYT : Nahrun Ganz')
	...
	def Spam():
		...
		if PilihTools == '1':
			...
			os.system('xdg-open http://wa.me/6283132663854?text=Hallo')
...
if __name__ == '__main__':
	print(C+'Subscribe YT'+W+' Gua Dlu Ya Ajg'+C+' :V')
	sleep(2)
	os.system('clear')
